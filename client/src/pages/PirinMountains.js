...
export const PirinMountains = ({
    hikes,
    onHikeDeleteClick,
}) => {
    return (
        <div className="module-container">
            <h1 className="page__title">Списък с маршрути в Пирин планина</h1>
            <div className="list">
                {hikes.filter(hike => hike.mountain.includes('Пирин' || 'пирин')).map(filteredHike => (
